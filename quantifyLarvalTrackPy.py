...
avi_path = tkFileDialog.askopenfilename(initialdir='e:/data/b/2016/')

FramesToProcess=range(60*60*10,60*60*30)
...
with tp.PandasHDFStore('d:/data_d.h5') as s:  # This opens an HDF5 file. Data will be stored and retrieved by frame number.
...
with tp.PandasHDFStore('d:/data_d.h5') as s:
...
allT=np.zeros([nFramesToProcess+1,80,2])
allT[:]=np.nan
